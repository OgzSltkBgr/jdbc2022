...
public class CallableStatement01 {
    ...
    SQL de ise data return ediyorsa "funciton" denir. Return yapmıyorsa "procedure" diye adlandırılır
    */
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //3.Adım : Fonksiyoınu çağır
        CallableStatement cst1 = con.prepareCall("{? = call toplamaF(?, ?)}");

        //4.Adım : Return için registerOutParameter() methodunu, parametreler iin set() methodlarından uygun olanları kullan
